...
parser.add_argument('--depth', default=1, type=int, metavar='G', help='number of gpus to use')
...
def main():
    ...
    model.load_state_dict(torch.load('History/NIH/ECNN1.pth'))
