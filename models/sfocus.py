        ...
        if self.dataset == 'ImageNet':
            ...
            if self.test == True:
                ...
                if self.plus == True:
                    ...
                    bw_loss /= len(A_t_la) # 왜 for loop 안에 들어가있었니... - Stella
                    ...
                    for idx, name in enumerate(self.grad_layers):
                        if idx == 0:
                            ...
                            A_t_in = F.relu(torch.mul(forward_feature, weights).sum(dim=1, keepdim=True)) # BS x 1 x 8 x 8 # originally sigmoid
